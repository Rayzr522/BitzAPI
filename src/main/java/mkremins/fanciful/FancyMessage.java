 ...
 * and a call to {@link #then()} or {@link #then(String)} will append a new
 * editing component to the end of the message,
 * optionally initializing it with text. Further property-setting method calls
 * will affect that editing component.
 * </p>
 */
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
     ...
     * currently edited part of the {@code FancyMessage} is clicked.
     * The client <b>will</b> immediately send the command to the server to be
     * executed when the editing component is clicked.
     *
     * @param command The text to display in the chat bar of the client.
     * @return This builder instance.
     */
     ...
     */ /*
        * ------------
        * public FancyMessage translationReplacements(final Iterable<? extends
     ...
     * construction of a new message component.
     ...
     * using a {@link JsonWriter}.
     * This JSON should be compatible with vanilla formatter commands such as
     * {@code /tellraw}.
     *
