...
public class CommandHandler implements CommandExecutor {
    ...
    private static final String          TITLE                    = ChatColor.DARK_GRAY + " " + ChatColor.STRIKETHROUGH + Strings.repeat("-", 10) + Messenger.TITLE + " COMMANDS" + ChatColor.DARK_GRAY
