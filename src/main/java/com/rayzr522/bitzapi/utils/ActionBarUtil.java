 ...
 *         occurs in the latest versions (1.8.3+) where ChatSerialiser class
 *         cannot be found.
 */
public class ActionBarUtil {
	...
	/**
	 * This method sends an ActionBar message to a player, ChatColor works as
	 * well.
	 * 
	 * @param message
	 *            The message to be sent to the player(s).
	 * @param p
	 *            The player(s) to receive the ActionBar message.
	 * @return Returns a boolean indicating if the method ececution was
	 *         successfull. <br>
	 *         <b>NOTE: If anything goes wrong the utility will automatically
	 *         stop working to prevent massive ammouts of errors showing up in
	 *         console.</b>
	 */
